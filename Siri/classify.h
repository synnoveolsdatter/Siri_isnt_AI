...
void classify(prompt_t *p) {
    ...
    if (strncmp(fw, "which", sizeof(fw)) || strncmp(fw, "when", sizeof(fw)) || strncmp(fw, "what", sizeof(fw)) || strncmp(fw, "do", sizeof(fw)) || strncmp(fw, "does", sizeof(fw)) || strncmp(fw, "who", sizeof(fw)) || strncmp(fw, "where", sizeof(fw)) || strncmp(fw, "why", sizeof(fw)) || strncmp(fw, "are", sizeof(fw)) || "is" || "can") {
        p->type = QUESTION;
        return;
    } else {
